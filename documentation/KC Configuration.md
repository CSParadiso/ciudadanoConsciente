...
Objetivo: documentar las configuraciones de Keycloak, incluídos: la base de datos, el compose.yaml y las configuraciones de Reinos, Clientes, Organnizaciones, Roles, Grupos, etc. Todo lo que se utilizado. Si sigue el orden de cada uno de los apartados, debería poder replicar el desarrollo.
