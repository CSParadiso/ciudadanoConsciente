...
-- Create user
CREATE USER saimon WITH PASSWORD 'citizen' SUPERUSER;
...
7	Me precocupa no poder conectarme a Keycloak	2024-03-07	11	https://www.keycloak.org/server/configuration
8	Me precocupa no poder vincular Keycloak a la API	2024-03-07	11	https://www.keycloak.org/server/configuration
\.
...
SELECT pg_catalog.setval('app.questions_question_id_seq', 8, true);
