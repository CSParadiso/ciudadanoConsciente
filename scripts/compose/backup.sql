...
CREATE TABLE app.activity_types (
    ...
    functional_template_url character varying(500) NOT NULL,
...
--
-- Name: answers_status; Type: TABLE; Schema: app; Owner: saimon
--

CREATE TABLE app.answers_status (
    answers_status_id integer NOT NULL,
    title character varying(50) NOT NULL,
    description character varying(500) NOT NULL
);


ALTER TABLE app.answers_status OWNER TO saimon;

--
-- Name: answers_status_answers_status_id_seq; Type: SEQUENCE; Schema: app; Owner: saimon
--

ALTER TABLE app.answers_status ALTER COLUMN answers_status_id ADD GENERATED ALWAYS AS IDENTITY (
...
COPY app.activity_types (activity_type_id, name, description, functional_template_url, creator) FROM stdin;
19	Pruab de creacion de actividad	Drag and drop	www.alternativeto.com	11
9	nuwerll	wer	werwer	9
10	Prueba	Prueba de Creacion de Tipo de Actividad	https://github.com/CSParadiso/simuladorProcesos.git	9
14	Nuevo nombre de prueba	Nueva descripcion solita	Otra url a cambiar	9
16	Click and bate	Clickear donde veas fake news	www.brave.com	9
1	FK DELETED	The ActivityType has been deleted	FK DELETED	11
\.
...
COPY app.answers (answer_id, created, activity, user_id, status, last_modified) FROM stdin;
1	2024-01-09	5	5	1	2024-01-09
\.


--
-- Data for Name: answers_status; Type: TABLE DATA; Schema: app; Owner: saimon
--

COPY app.answers_status (answers_status_id, title, description) FROM stdin;
1	NEW	Initial state of answer. (First stage).
2	INSTANCIATED	Answer choosed. (Second stage).
3	OK	Correct answer verified and saved. (Third stage).
4	NOT	Incorrect answer verified and saved. (Third stage).
5	CACHED	Answer choosed but not saved to DB by the user. (Third stage).
\.
...
SELECT pg_catalog.setval('app.activity_types_activity_type_id_seq', 19, true);
...
SELECT pg_catalog.setval('app.answers_status_answers_status_id_seq', 6, true);
...
SELECT pg_catalog.setval('app.entities_allowed_votes_entities_allowed_votes_id_seq', 5, true);
...
SELECT pg_catalog.setval('app.votes_vote_id_seq', 9, true);
...
--
-- Name: answers_status answers_status_pkey; Type: CONSTRAINT; Schema: app; Owner: saimon
--

ALTER TABLE ONLY app.answers_status
    ADD CONSTRAINT answers_status_pkey PRIMARY KEY (answers_status_id);


--
-- Name: answers_status answers_status_title_key; Type: CONSTRAINT; Schema: app; Owner: saimon
--
...
--
-- Name: answers answers_status_fkey; Type: FK CONSTRAINT; Schema: app; Owner: saimon
--

ALTER TABLE ONLY app.answers
    ADD CONSTRAINT answers_status_fkey FOREIGN KEY (status) REFERENCES app.answers_status(answers_status_id) ON DELETE SET DEFAULT;
