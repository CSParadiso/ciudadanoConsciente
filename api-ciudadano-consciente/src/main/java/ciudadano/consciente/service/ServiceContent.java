...
public class ServiceContent {
    ...
    public DTOImage addImage(DTOCreateImage dtoCreateImage) {
        ...
        audit.debug("Verifying extension and size of file."); // Todo esto podría ir en FileSystem (incluso la extension de los files allowed)
        ...
        if(!utilityFileSystem.smallerThanMaxMbAllowed(imageFile.length)) {
            throw new HttpBadRequestException("File size is larger than allowed (" + utilityFileSystem.getImageMaxMbFileSize() + "MB).");
        }
